/**
 * A Java class that implements a simple text learner, based on WEKA. To be used
 * with MyFilteredClassifier.java. WEKA is available at:
...
public class MyFilteredLearner {
    ...
    public static void main(String[] args) {
        ...
        learner.loadDataset("data\\ssarftorcuata\\1342565.arff");
        // Evaluation must be done before training
        // More info in: http://weka.wikispaces.com/Use+WEKA+in+your+Java+code
        learner.evaluate();
        learner.learn();
        learner.saveModel("data\\YesNo.model");
